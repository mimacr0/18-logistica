...
class DingTalkAPIError(Exception):
    """
    自定义钉钉 API 异常 (Custom DingTalk API exception)
    """
...
class DingTalkClient:
    """
    钉钉客户端 (DingTalk client)
    """

    def __init__(self, app_key, app_secret):
        """
        初始化客户端。(Inicializa el cliente.)
    ...
    def get_access_token(self):
        ...
        此方法是线程安全的。
        (If the current Token is invalid or about to expire, a new Token will be automatically obtained.
